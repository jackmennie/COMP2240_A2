 ...
 *      - Old MacDonald
 * 
 * Apparently new zealand farmers are stubborn
 * But this guy does a few things
 * 
 * Implements threads runnable and uses the bridges
 * semaphore to decide if they can cross the bridge or
 * not.
 * 
 * If the bridge says they cannot go on, then they wait
 * If the bridge says they can go on, then they start
 * crossing the bride.
 * 
 * 
 * Jack Mennie
